...
struct OwnerView_Previews: PreviewProvider {
	static var previews: some View {
		NavigationView {
			OwnerView(model: OwnerViewModel(owner: Owner(firstName: "Restaurant", lastName: "Owner", email: "owner", restaurants: [
		...
		NavigationView {
			OwnerView(model: OwnerViewModel(owner: Owner(firstName: "Restaurant", lastName: "Owner", email: "owner")))
		}
	}
}
